...
class CsvEmployeeManager {
    ...
    public:
        ...
        void write() {
            ...
            // if (typeid(object) == typeid(Veterinary)) {
            //     file << "Veterinário" << ";";
            // } else if (typeid(object) == typeid(Handler)) {
            //     file << "T​ratador" << ";";
            // }
            // 
            ...
            //      << object.get_cpf() << ";"
            //      << object.get_age() << ";"
            //      << object.get_blood_type() << ";"
            //      << object.get_rh_factor() << ";"
            //      << object.get_specialty() << ";";
            //
            // if (typeid(object) == typeid(Veterinary)) {
            //     file << object.get_crmv() << ";"
            //          << "" << ";";
            // } else if (typeid(object) == typeid(Handler)) {
            //     file << "" << ";"
            //          << object.get_security_level() << ";";
            // }
